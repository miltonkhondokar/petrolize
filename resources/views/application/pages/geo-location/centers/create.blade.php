            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="center_form" method="POST" action="{{ route('centers.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" name="name" class="form-control form-control-solid"
                                                ...
                                                data-kt-validate-required="Center name is required"
                                            ...
                                            <div class="form-text">Unique name for the center</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <select name="governorate_uuid" class="form-select form-select-solid"
                                                data-kt-validate="true"
                                                data-kt-validate-required="Governorate is required">
                                                <option value="">Select Governorate</option>
                                                @foreach($governorates as $governorate)
                                                    <option value="{{ $governorate->uuid }}" 
                                                        {{ old('governorate_uuid') == $governorate->uuid ? 'selected' : '' }}>
                                                        {{ $governorate->name }}
                                            ...
                                            <div class="form-text">Select the governorate this center belongs to</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="form-text">Active centers will be available for selection</div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    <script>
        ...
        document.querySelectorAll('#center_form [data-kt-validate="true"]').forEach(input => {
        ...
        document.getElementById('center_form').addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this center?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create center',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            document.querySelectorAll('#center_form .is-invalid').forEach(el => {
                el.classList.remove('is-invalid');
            });
            document.querySelectorAll('#center_form .invalid-feedback').forEach(el => {
                el.remove();
            });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('center_form').reset();
                }
            });
        });
    </script>
