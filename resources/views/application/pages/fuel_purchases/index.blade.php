                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select name="vendor_uuid" class="form-select form-select-solid">
                                ...
                                @foreach(($vendors ?? []) as $v)
                                    <option value="{{ $v->uuid }}" {{ ($filters['vendor_uuid'] ?? '') === $v->uuid ? 'selected' : '' }}>
                                        {{ $v->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-2">
                            <select name="status" class="form-select form-select-solid">
                                ...
                                <option value="received_partial" {{ $st==='received_partial' ? 'selected' : '' }}>Received Partial</option>
                                <option value="received_full" {{ $st==='received_full' ? 'selected' : '' }}>Received Full</option>
                            </select>
                        </div>
                        ...
                        <tbody>
                            @forelse($purchases as $index => $purchase)
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-muted" title="{{ optional($purchase->purchase_date)->format('d M Y') }}">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ route('fuel_purchases.show', $purchase->uuid) }}" class="dropdown-item">
                                                ...
                                                <li>
                                                    <a href="{{ route('fuel_purchases.edit', $purchase->uuid) }}" class="dropdown-item">
