                    ...
                    <form method="GET" action="{{ route('complaint-category.index') }}">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="{{ route('complaint-category.index') }}" class="btn btn-warning ms-2">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('complaint-category.show', $complaint->uuid) }}" class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('complaint-category.edit', $complaint->uuid) }}" class="dropdown-item">
