                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-light-{{ $price->is_active ? 'success' : 'danger' }}">
                                                <i
                                                    class="ki-duotone {{ $price->is_active ? 'ki-check-circle' : 'ki-cross' }} fs-5 me-1"></i>
                                                {{ $price->is_active ? 'Active' : 'Inactive' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-muted"
                                                title="{{ $price->created_at->format('d M Y, h:i A') }}">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('fuel-unit-price.show', $price->uuid) }}" class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('fuel-unit-price.edit', $price->uuid) }}" class="dropdown-item">
