                                            ...
                                            <select name="fuel_type_uuid" class="form-select form-select-solid"
                                                ...
                                                @foreach ($fuelTypes as $fuelType)
                                                    <option value="{{ $fuelType->uuid }}"
                                                        {{ old('fuel_type_uuid') == $fuelType->uuid ? 'selected' : '' }}>
...
@push('scripts')
    <script>
        ...
        document.getElementById('fuel_unit_price_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this fuel unit price?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create price',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            document.querySelectorAll('#fuel_unit_price_form .is-invalid').forEach(el => {
                el.classList.remove('is-invalid');
            });
            document.querySelectorAll('#fuel_unit_price_form .invalid-feedback').forEach(el => {
                el.remove();
            });
