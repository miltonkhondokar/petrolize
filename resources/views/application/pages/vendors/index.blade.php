            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body py-3">
                    <div class="table-responsive overflow-visible">
                        <table class="table align-middle table-row-dashed table-bordered fs-6 gy-4">
                            <thead class="bg-light-dark">
                                <tr class="fw-bold text-gray-700">
                                    ...
                                    <th>
                                        <div class="d-flex align-items-center">
                                            <i class="ki-duotone ki-gas-station fs-2 me-2 text-danger">
                                                <i class="path1"></i><i class="path2"></i>
                                            </i>
                                            Fuel Stocks
                                        </div>
                            ...
                            <tbody>
                                @forelse ($vendors as $index => $vendor)
                                    <tr>
                                        ...
                                        <td>
                                            @if($vendor->email)
                                                <a href="mailto:{{ $vendor->email }}" class="text-info">
                                                    {{ $vendor->email }}
                                                </a>
                                            @else
                                        ...
                                        <td>
                                            @if($vendor->phone)
                                                <a href="tel:{{ $vendor->phone }}" class="text-success">
                                                    {{ $vendor->phone }}
                                                </a>
                                            @else
                                                <span class="text-muted">-</span>
                                        ...
                                        <td>
                                            <span class="badge badge-light-{{ $vendor->is_active ? 'success' : 'danger' }}">
                                                <i
                                                    class="ki-duotone {{ $vendor->is_active ? 'ki-check-circle' : 'ki-cross' }} fs-5 me-1"></i>
                                                {{ $vendor->is_active ? 'Active' : 'Inactive' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-muted"
                                                title="{{ $vendor->created_at->format('d M Y, h:i A') }}">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('vendors.show', $vendor->uuid) }}" class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('vendors.edit', $vendor->uuid) }}" class="dropdown-item">
                        ...
                        <!-- Pagination -->
                        <div class="mt-4">
                            {{ $vendors->appends($filters)->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
