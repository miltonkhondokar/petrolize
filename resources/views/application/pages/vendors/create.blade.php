            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="vendor_form" method="POST" action="{{ route('vendors.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea name="address" class="form-control form-control-solid" 
                                                ...
                                                data-kt-validate-pattern-msg="Only letters, numbers, spaces, hyphens, commas, dots, # and newlines, max 255 characters">{{ old('address') }}</textarea>
        ...
        document.getElementById('vendor_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this vendor?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create vendor',
