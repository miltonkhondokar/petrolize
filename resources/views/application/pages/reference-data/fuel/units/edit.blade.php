            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="fuel_unit_form" method="POST" action="{{ route('fuel-unit.update', $fuelUnit->uuid) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" name="abbreviation" class="form-control form-control-solid"
                                                ...
                                                value="{{ old('abbreviation', $fuelUnit->abbreviation) }}"
                                                data-kt-validate="true" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea name="description" class="form-control form-control-solid" 
                                                ...
                                                data-kt-validate-pattern-msg="Only letters, numbers, spaces, hyphens, commas and dots, max 255 characters">{{ old('description', $fuelUnit->description) }}</textarea>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <select name="is_active" class="form-select form-select-solid"
                                                ...
                                                <option value="1" {{ old('is_active', $fuelUnit->is_active) == '1' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ old('is_active', $fuelUnit->is_active) == '0' ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                ...
                                <div class="text-end mt-8">
                                    <a href="{{ route('fuel-unit.index') }}" class="btn btn-light me-3 btn-sm">
        ...
        document.getElementById('fuel_unit_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to update this fuel unit?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, update fuel unit',
