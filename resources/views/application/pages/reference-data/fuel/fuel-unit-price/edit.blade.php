            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="fuel_unit_price_form" method="POST" action="{{ route('fuel-unit-price.update', $stationUuid) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            >
                                                ...
                                                @foreach ($fuelStations as $fuelStation)
                                                    <option
                                                        ...
                                                        {{ (old('fuel_station_uuid') ?? $stationUuid) == $fuelStation->uuid ? 'selected' : '' }}
                                                    >
                                                        {{ $fuelStation->name }}
                                            ...
                                            <div class="form-text">Change station to edit its fuel prices</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="p-4 rounded bg-light">
                                                <div class="text-muted">
                                                    Update <b>price per unit</b> and toggle <b>enabled/disabled</b> for each
                                                    <b>active fuel type</b> of the selected station.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="fuelTypesWrapper" class="mt-4" style="display:none;">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <small class="text-muted">Edit price and enable/disable per fuel type</small>
                                    </div>
...
@push('scripts')
    <script>
        ...
        function renderRows(fuelTypes, pricesArr) {
            ...
            // Attach live validation handlers to dynamically created inputs
            document.querySelectorAll('#fuel_unit_price_form [data-kt-validate="true"]').forEach(input => {
                if (input.dataset._bound === '1') return;
        ...
        // load on page init (selected station)
        ...
        document.getElementById('fuel_unit_price_form').addEventListener('submit', async function(e) {
            ...
            for (const input of inputs) {
                let ok = true;
                if (input.tagName === 'SELECT') ok = validateSelect(input);
                else ok = validateInput(input);
            ...
            const result = await Swal.fire({
                ...
                text: 'Are you sure you want to update these fuel unit prices?',
                icon: 'question',
