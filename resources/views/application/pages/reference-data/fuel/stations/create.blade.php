                                            ...
                                            <select name="user_uuid" class="form-select form-select-solid">
                                                ...
                                                @foreach ($managers as $manager)
                                                    <option value="{{ $manager->uuid }}"
                                                        {{ old('user_uuid') == $manager->uuid ? 'selected' : '' }}>
...
@push('scripts')
    <script>
        ...
        document.getElementById('fuel_station_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this fuel station?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create fuel station',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            document.querySelectorAll('#fuel_station_form .is-invalid').forEach(el => {
                el.classList.remove('is-invalid');
            });
            document.querySelectorAll('#fuel_station_form .invalid-feedback').forEach(el => {
                el.remove();
            });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('fuel_station_form').reset();
                }
            });
        });
    </script>
