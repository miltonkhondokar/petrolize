        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('fuel.index') }}">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('fuel.index') }}" class="btn btn-warning w-100">
            ...
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center bg-light-danger">
                    <h3 class="card-title fw-bold fs-3 mb-1">Fuel Types List</h3>
                    <a href="{{ route('fuel.create') }}" class="btn btn-sm btn-primary">
                        <i class="ki-outline ki-plus-circle fs-3 me-1"></i> Add New Fuel Type
                    </a>
                </div>
                <div class="card-body py-3">
                    <div class="table-responsive overflow-visible">
                        <table class="table align-middle table-row-dashed table-bordered fs-6 gy-4">
                            ...
                            <tbody>
                                @forelse ($fuelTypes as $index => $fuel)
                                    <tr>
                                        <td>{{ $fuelTypes->firstItem() + $index }}</td>
                                        ...
                                        <td>
                                            {{ $fuel->defaultUnit->name ?? '-' }}
                                        </td>
                                        <td>
                                            <span class="badge badge-light-{{ $fuel->is_active ? 'success' : 'danger' }}">
                                                <i
                                                    class="ki-duotone {{ $fuel->is_active ? 'ki-check-circle' : 'ki-cross' }} fs-5 me-1"></i>
                                                {{ $fuel->is_active ? 'Active' : 'Inactive' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-muted"
                                                title="{{ $fuel->created_at->format('d M Y, h:i A') }}">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('fuel.show', $fuel->uuid) }}" class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('fuel.edit', $fuel->uuid) }}" class="dropdown-item">
                        ...
                        <!-- Pagination -->
                        <div class="mt-4">
                            {{ $fuelTypes->appends($filters)->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
