            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="fuel_form" method="POST" action="{{ route('fuel.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                            ...
                                            <select name="fuel_unit_uuid" class="form-select form-select-solid"
                                                ...
                                                @foreach ($fuelUnits as $unit)
                                                    <option value="{{ $unit->uuid }}"
                                                        {{ old('fuel_unit_uuid') == $unit->uuid ? 'selected' : '' }}>
    ...
    <script>
        ...
        document.getElementById('fuel_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this fuel type?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create fuel type',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('fuel_form').reset();
                }
            });
        });
    </script>
