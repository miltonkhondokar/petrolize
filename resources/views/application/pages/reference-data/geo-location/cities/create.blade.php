            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="city_form" method="POST" action="{{ route('cities.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" name="name" class="form-control form-control-solid"
                                                ...
                                                data-kt-validate-required="City name is required"
                                            ...
                                            <div class="form-text">Unique name for the city</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <select name="center_uuid" class="form-select form-select-solid"
                                                data-kt-validate="true"
                                                data-kt-validate-required="Center is required">
                                                <option value="">Select Center</option>
                                                @foreach($centers as $center)
                                                    <option value="{{ $center->uuid }}" 
                                                        {{ old('center_uuid') == $center->uuid ? 'selected' : '' }}>
                                                        {{ $center->name }}
                                            ...
                                            <div class="form-text">Select the center this city belongs to</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="form-text">Active cities will be available for selection</div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    <script>
        ...
        document.querySelectorAll('#city_form [data-kt-validate="true"]').forEach(input => {
        ...
        document.getElementById('city_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this city?',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, create city',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            document.querySelectorAll('#city_form .is-invalid').forEach(el => {
                el.classList.remove('is-invalid');
            });
            document.querySelectorAll('#city_form .invalid-feedback').forEach(el => {
                el.remove();
            });
