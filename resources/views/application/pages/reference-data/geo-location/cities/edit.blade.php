            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="city_form" method="POST" action="{{ route('cities.update', $city->uuid) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Left column -->
                                            ...
                                            <select name="center_uuid" class="form-select form-select-solid"
                                                ...
                                                @foreach($centers as $center)
                                                    <option value="{{ $center->uuid }}" 
                                                        {{ old('center_uuid', $city->center_uuid) == $center->uuid ? 'selected' : '' }}>
                                                        {{ $center->name }}
                                ...
                                <div class="text-end mt-8">
                                    <a href="{{ route('cities.index') }}" class="btn btn-light me-3 btn-sm">
        ...
        document.getElementById('city_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    confirmButtonText: 'Yes, update city',
