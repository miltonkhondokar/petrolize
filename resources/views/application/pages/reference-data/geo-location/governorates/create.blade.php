            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="governorate_form" method="POST" action="{{ route('governorates.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                            ...
                                            <select name="region_uuid" class="form-select form-select-solid"
                                                ...
                                                @foreach($regions as $region)
                                                    <option value="{{ $region->uuid }}" 
                                                        {{ old('region_uuid') == $region->uuid ? 'selected' : '' }}>
                                                        {{ $region->name }}
...
@push('scripts')
    <script>
        ...
        document.getElementById('governorate_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    confirmButtonText: 'Yes, create governorate',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            ...
            document.querySelectorAll('#governorate_form .is-invalid').forEach(el => {
                el.classList.remove('is-invalid');
            });
            document.querySelectorAll('#governorate_form .invalid-feedback').forEach(el => {
                el.remove();
            });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('governorate_form').reset();
                }
            });
        });
    </script>
