            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="center_form" method="POST" action="{{ route('centers.update', $center->uuid) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Left column -->
                                            ...
                                            <select name="governorate_uuid" class="form-select form-select-solid"
                                                ...
                                                @foreach($governorates as $governorate)
                                                    <option value="{{ $governorate->uuid }}" 
                                                        {{ old('governorate_uuid', $center->governorate_uuid) == $governorate->uuid ? 'selected' : '' }}>
                                                        {{ $governorate->name }}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <select name="is_active" class="form-select form-select-solid"
                                                ...
                                                <option value="1" {{ old('is_active', $center->is_active) == '1' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ old('is_active', $center->is_active) == '0' ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                ...
                                <div class="text-end mt-8">
                                    <a href="{{ route('centers.index') }}" class="btn btn-light me-3 btn-sm">
        ...
        document.getElementById('center_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    confirmButtonText: 'Yes, update center',
