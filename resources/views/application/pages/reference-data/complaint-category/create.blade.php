            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="complaint_category_form" method="POST" action="{{ route('complaint-category.store') }}">
                                @csrf
                                <div class="row">
                                    <!-- Left column -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" name="code" class="form-control form-control-solid"
                                                placeholder="Enter category code (e.g., fuel_shortage)" 
                                                value="{{ old('code') }}"
                                                data-kt-validate="true" 
                                                data-kt-validate-required="Category code is required"
                                                data-kt-validate-pattern="^[a-z_]+$"
                                                data-kt-validate-pattern-msg="Only lowercase letters and underscores allowed" />
                                            <div class="form-text">Unique code for the category (lowercase with underscores)</div>
                                        </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea name="description" class="form-control form-control-solid" rows="3"
                                        ...
                                        data-kt-validate-pattern-msg="Maximum 500 characters allowed">{{ old('description') }}</textarea>
        ...
        document.getElementById('complaint_category_form').addEventListener('submit', async function(e) {
            ...
            if (valid) {
                ...
                const result = await Swal.fire({
                    ...
                    text: 'Are you sure you want to create this complaint category?',
                    icon: 'question',
        ...
        document.querySelector('button[type="reset"]').addEventListener('click', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    document.querySelectorAll('#complaint_category_form .is-invalid').forEach(el => {
                        el.classList.remove('is-invalid');
                    });
                    document.querySelectorAll('#complaint_category_form .invalid-feedback').forEach(el => {
                        el.remove();
                    });
                    document.getElementById('complaint_category_form').reset();
                }
            });
        });
    </script>
