                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-flush shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center bg-light-primary">
                            ...
                            <a href="{{ route('complaints.index') }}" class="btn btn-sm btn-primary">
                                <i class="bi bi-arrow-left fs-3 me-2"></i>
                                Back to List
                            </a>
                        </div>
                        <div class="card-body">
                            <form id="complaint_form" method="POST" action="{{ route('complaints.update', $complaint->uuid) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Left column -->
                                            ...
                                            <select name="category" class="form-select form-select-solid">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category }}"
                                                        {{ old('category', $complaint->category) == $category ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="date" name="complaint_date" class="form-control form-control-solid"
                                                value="{{ old('complaint_date', \Carbon\Carbon::parse($complaint->complaint_date)->format('Y-m-d')) }}"
                                                data-kt-validate="true" 
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="date" name="resolved_date" class="form-control form-control-solid"
                                                value="{{ old('resolved_date', $complaint->resolved_date ? \Carbon\Carbon::parse($complaint->resolved_date)->format('Y-m-d') : '') }}" />
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <select name="is_active" class="form-select form-select-solid"
                                                ...
                                                <option value="1" {{ old('is_active', $complaint->is_active) == '1' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ old('is_active', $complaint->is_active) == '0' ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea name="description" class="form-control form-control-solid" 
                                                ...
                                                data-kt-validate-pattern-msg="Only letters, numbers, spaces and basic punctuation, max 1000 characters">{{ old('description', $complaint->description) }}</textarea>
                                ...
                                <div class="text-end mt-8">
                                    <a href="{{ route('complaints.index') }}" class="btn btn-light me-3 btn-sm">
