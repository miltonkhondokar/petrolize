...
class CostCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('application.pages.cost-category.index', compact('categories', 'filters', 'breadcrumb'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.cost-category.create', compact('breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.cost-category.edit', compact('category', 'breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.cost-category.show', compact('category', 'breadcrumb'));
    }
