...
class UserMasterDataController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('application.pages.users.index', compact('users', 'filters', 'breadcrumb'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.users.create', compact('breadcrumb', 'roles', 'userTypes'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.user-master-data.show', compact('user', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.user-master-data.edit', compact('user', 'roles', 'breadcrumb'));
    }
