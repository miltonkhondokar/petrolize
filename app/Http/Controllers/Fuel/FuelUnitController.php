...
class FuelUnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('application.pages.fuel.units.index', compact('fuelUnits', 'filters', 'breadcrumb'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.fuel.units.create', compact('breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.fuel.units.show', compact('fuelUnit', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.fuel.units.edit', compact('fuelUnit', 'breadcrumb'));
    }
