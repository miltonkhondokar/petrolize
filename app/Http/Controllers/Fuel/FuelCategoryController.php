...
class FuelCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('application.pages.fuel.types.index', compact('breadcrumb', 'fuelTypes', 'fuelUnits', 'filters'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.fuel.types.create', compact('fuelUnits', 'breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.fuel.types.show', compact('fuel', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.fuel.types.edit', compact('fuel', 'fuelUnits', 'breadcrumb'));
    }
