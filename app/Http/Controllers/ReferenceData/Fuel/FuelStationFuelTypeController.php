...
class FuelStationFuelTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('application.pages.reference-data.fuel.station-fuel-type.index', compact('assignments', 'filters', 'fuelStations', 'fuelTypes', 'breadcrumb'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.reference-data.fuel.station-fuel-type.create',
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.reference-data.fuel.station-fuel-type.show', compact('assignment', 'breadcrumb'));
    }
