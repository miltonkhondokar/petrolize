...
class GovernorateController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('application.pages.reference-data.geo-location.governorates.index', compact('breadcrumb', 'governorates', 'regions', 'filters'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.reference-data.geo-location.governorates.create', compact('regions', 'breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.governorates.show', compact('governorate', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.governorates.edit', compact('gov', 'regions', 'breadcrumb'));
    }
