...
class CenterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('application.pages.reference-data.geo-location.centers.index', compact('breadcrumb', 'centers', 'governorates', 'filters'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.reference-data.geo-location.centers.create', compact('breadcrumb', 'governorates'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.centers.show', compact('center', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.centers.edit', compact('center', 'governorates', 'breadcrumb'));
    }
