...
class CityController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('application.pages.reference-data.geo-location.cities.index', compact('breadcrumb', 'cities', 'centers', 'filters'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.reference-data.geo-location.cities.create', compact('centers', 'breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.cities.show', compact('city', 'breadcrumb'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('application.pages.reference-data.geo-location.cities.edit', compact('city', 'centers', 'breadcrumb'));
    }
