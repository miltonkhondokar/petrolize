...
class RegionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('application.pages.geo-location.regions.index', compact('breadcrumb', 'regions', 'filters'));
    }
    ...
    public function create()
    {
        ...
        return view('application.pages.geo-location.regions.create', compact('breadcrumb'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('application.pages.geo-location.regions.show', compact('region', 'breadcrumb'));
    }
